export default function Projects() {
  const projects = [
    {
      id: 1,
      title: "University AI Assistant: Multi-Agent Timetable Management System",
      description: "Designed a multi-agent LangGraph workflow for automated UniTime schedule extraction. Engineered an XML-to-natural language pipeline to format complex schedule data for LLM input. Built a FAISS-powered multimodal RAG pipeline for semantic course schedule search.",
      image: "/images/unitime.png",
      technologies: ["LangGraph", "ReAct", "FAISS", "Krutrim AI", "UniTime"],
      github: "https://github.com/Raihan2511/UniAssist_Ai/tree/main",
  ...
  return (
    <section id="projects" className="py-16 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        {/* Horizontal scroll track — clips to the section width */}
        <div className="overflow-hidden rounded-2xl">
          ...
          {projects.map((project, projectIndex) => (
            <div
              key={project.id}
              className="group relative bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl rounded-2xl shadow-xl border border-white/20 dark:border-gray-700/30 overflow-hidden flex-shrink-0"
              style={{
                width: '360px',
